...
import { User, Trash2, Edit3, MapPin, ShieldCheck, Users } from 'lucide-react';
...
export default function CoordinatorList({ coordinators, members, onDelete, onEdit, onSelect }: CoordinatorListProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {coordinators.map((coordinator) => {
        const memberCount = members.filter(m => m.coordinatorId === coordinator.id).length;
